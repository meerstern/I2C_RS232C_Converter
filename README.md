...
## 注意 
  ...
  * D-sub9ピンの受信の2ピン、送信の3ピン、GNDの5ピン以外はTTLレベルのため、必要に応じて未接続にしてください(v1.0/v1.1のみ)
  * D-sub9ピンの受信の2ピン、送信の3ピン、GNDの5ピン以外のRTS/CDSはRS232Cレベルに変換されています(v1.2以降, v1.3はR14を必要に応じて実装してください)    
